...
public class DicomParseUtil {
     ...
     */
    public static String dicomDate(Attributes object, int Tag, boolean valueBool, String valueNoun) {
        ...
        if (Numero.matches("^[0-9]*$")) {//If la chaine de caractère est un nombre ou un chiffre
            ...
            if (valueBool) {//Format yyyy.mm.dd
                for (int i = 0, j = Numero.length(); i < j; i++) {
                    ...
                    if ((i == 3) || (i == 5)) {
                        if (valueNoun != null && valueNoun.equals("dot")) {
                            r.append('.');
                        } else {
                            r.append(' ');
                        }
...
//System.out.print(value[1]);
     ...
     */
    public String dicomTime2(Attributes object, int Tag) {
        String tagValue = object.getString(Tag);
        String tagValueNotDot = formatNotDot(tagValue);
     ...
     * @return new value String
     */
    public String dicomTime3(Attributes object, int Tag) {
        String tagValue = object.getString(Tag);
        String tagTimeFomat = FormatTimes(tagValue);
        return tagTimeFomat;
    }
     ...
     * @return afficher le string du tag selon le standard international/ return string Date
     */
    public String dicomDate(int Tag, boolean valueBool, String valueNoun) {
